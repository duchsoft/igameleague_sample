...
public class IGL
{
    ...
    static string URL_FORMAT = "https://www.sandbox-igameleague.azurewebsites.net/Service.asmx/{0}";
    static string REGISTRATION_URL = "http://sandbox-igameleague.azurewebsites.net/Registration.aspx";
    static string LEADERBOARD_URL = "http://sandbox-igameleague.azurewebsites.net/ScoreboardDetails.aspx";
    static string PLAYER_PAGE_URL = "http://sandbox-igameleague.azurewebsites.net/PlayerZone/PlayerPage.aspx";
    static string ENTRYKEY_URL = "http://sandbox-igameleague.azurewebsites.net/EntryKey.aspx";
    ...
    public IGL(string developerId, string integrationKey, bool sandboxMode)
    {
        ...
        if (m_SandboxMode)
        {
            URL_FORMAT = "https://sandbox-igameleague.azurewebsites.net/Service.asmx/{0}";
            REGISTRATION_URL = "http://sandbox-igameleague.azurewebsites.net/Registration.aspx";
            LEADERBOARD_URL = "http://sandbox-igameleague.azurewebsites.net/ScoreboardDetails.aspx";
            PLAYER_PAGE_URL = "http://sandbox-igameleague.azurewebsites.net/PlayerZone/PlayerPage.aspx";
            ENTRYKEY_URL = "http://sandbox-igameleague.azurewebsites.net/EntryKey.aspx";
        }
        else
        {
            URL_FORMAT = "https://www.igameleague.azurewebsites.net/Service.asmx/{0}";
            REGISTRATION_URL = "http://igameleague.azurewebsites.net/Registration.aspx";
            LEADERBOARD_URL = "http://igameleague.azurewebsites.net/ScoreboardDetails.aspx";
            PLAYER_PAGE_URL = "http://igameleague.azurewebsites.net/PlayerZone/PlayerPage.aspx";
            ENTRYKEY_URL = "http://igameleague.azurewebsites.net/EntryKey.aspx";
        }
    }
